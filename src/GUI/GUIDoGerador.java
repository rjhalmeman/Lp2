...
import Controle.GerarValidadorCPF;
...
public class GUIDoGerador extends JFrame {
    ...
    private final JButton btGerarValidador = new JButton("Validador");
    ...
    public GUIDoGerador() {
        ...
        btGerarEstrutura.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                listaString.add("/src/" + "ValidadorCPF");
                ...
                if (listaIcones.exists()) {
                    ...
                    for (int i = 0; i < arqs.length; i++) {
                       ...
                       System.out.println("destino " + caminho + "/src" + "/myUtil/" + arqs[i].getName());
        ...
        btGerarValidador.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                System.out.println("lalalalalalalalalalallalalalalal ");
                String nomeDaClasse = tfNomeClasse.getText();
                //btGerarValidador.doClick();
                caminho = tfDestino.getText();
                String oArquivo = "src/txts/" + tfNomeClasse.getText() + ".txt";
                File file = new File(oArquivo);
                if (file.exists()) {
                    List<String> atributo = manipulaArquivo.abrirArquivo(oArquivo);
                    GerarValidadorCPF gerarValidadorCPF = new GerarValidadorCPF(nomeDaClasse, atributo, caminho);
                }
