...
public class JanelaPesquisar_1 extends JDialog {
    ...
    public JanelaPesquisar_1(List<String> lista, int x, int y) {//esse construtor é importante para receber dados 
        this.lista = lista;
        this.x = x;
        this.y = y;
    }

    public JanelaPesquisar_1(List<String> lista, int x, int y, Dimension dimensao, String titulo) {//esse construtor é importante para receber dados 
        this.lista = lista;
        this.x = x;
        this.y = y;
