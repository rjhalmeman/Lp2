...
public class DB_Direct {
    ...
    public DB_Direct(String serverName, String schema, String userName, String password, String entidade) {
        c = new DB_Direct_Connection(serverName, schema, userName, password, entidade);
        connection = c.getConexao();
    }
