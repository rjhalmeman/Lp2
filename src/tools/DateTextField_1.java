...
public class DateTextField_1 extends JTextField {
    ...
    public DateTextField_1() {
        this(new Date());
    }

    public DateTextField_1(String dateFormatPattern, Date date) {
        this(date);
        DEFAULT_DATE_FORMAT = dateFormatPattern;
    }

    public DateTextField_1(Date date) {
        setDate(date);
        setEditable(false);
    ...
    private void showDateDialog(DatePanel dateChooser, Point position) {
        Window owner = (Window) SwingUtilities
                .getWindowAncestor(DateTextField_1.this);
