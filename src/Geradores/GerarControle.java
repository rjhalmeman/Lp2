        ...
        for (int i = 0; i < atributo.size(); i++) {
            ...
            switch (auxiliaSplit[0]) {
                ...
                case "double":
                    ...
                    break;
                case "float":
                    ss = ss + "Float.valueOf(aux[" + i + "]),";
                    break;
                case "Date":
                    ss = ss + "cdf.converteDeStringParaDate(aux[" + i + "]),";
                    break;
                case "boolean":
...
//        }
        ...
        if (destino.existeOArquivo(caminhoDoProjetoDestino)) {
            destino.salvarArquivo(caminhoDoProjetoDestino + "/src/Controles/" + st.plMaiusc(nomeClasse) + "Controle.java", codigo);
        }
